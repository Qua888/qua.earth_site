...
void main() {
	...
	`}var Q=class extends tn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new _i(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Es={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Ds(e,t){let n=Es[t];return n===void 0?(G(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Os=new q;function ks(){return Ht.getLuminanceCoefficients(Os),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Os.x.toFixed(4)}, ${Os.y.toFixed(4)}, ${Os.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`,qc=`
  ...
  vec3 starfield(vec3 rd) {
    ...
    vec3 stars = lighterTemperature * (body * 3.0 + halo * 1.35 + sparkle * 0.8) * 2.128;
...
`,Xc=135,Zc={hats:1,shaker:2,pad:4,pulse:8,dub:16,clap:32},Qc=[1,2,4,8,16,32],$c=[{id:`deep`,label:`Deep`,description:`Submerged chords and a deep rolling bass`},{id:`glass`,label:`Glass`,description:`Crystalline echoes and a syncopated bass`},{id:`velvet`,label:`Velvet`,description:`Warm suspended chords and a spacious pulse`}];function el(){let e=window.AudioContext??window.webkitAudioContext;if(!e)return null;let t;try{t=new e({latencyHint:`playback`})}catch{try{t=new e}catch{return null}}let n=60/Xc,r=n/2,i=t.createGain(),a=t.createDynamicsCompressor(),o=t.createBiquadFilter(),s=t.createBiquadFilter(),c=t.createBiquadFilter(),l=t.createBiquadFilter(),u=t.createDelay(1.2),d=t.createBiquadFilter(),f=t.createBiquadFilter(),p=t.createGain(),m=t.createConvolver(),h=t.createGain(),g=t.createBuffer(1,Math.round(t.sampleRate*1.6),t.sampleRate);i.gain.value=1e-4,a.threshold.value=-22,a.knee.value=18,a.ratio.value=3.2,a.attack.value=.015,a.release.value=.32,o.type=`highpass`,o.frequency.value=50,o.Q.value=Math.SQRT1_2,s.type=`lowpass`,s.frequency.value=200,s.Q.value=Math.SQRT1_2,o.connect(s),s.connect(i),c.type=`highpass`,c.frequency.value=856,c.Q.value=Math.SQRT1_2,c.connect(i),l.type=`peaking`,l.frequency.value=Math.sqrt(200*850),l.Q.value=.65,l.gain.value=-14,i.connect(l),l.connect(a),a.connect(t.destination),u.delayTime.value=n*.75,d.type=`highpass`,d.frequency.value=856,f.type=`lowpass`,f.frequency.value=4200,f.Q.value=.8,p.gain.value=.53,u.connect(d),d.connect(f),f.connect(p),p.connect(u),f.connect(c);let _=Math.round(t.sampleRate*2.2),v=t.createBuffer(2,_,t.sampleRate);for(let e=0;e<v.numberOfChannels;e+=1){let t=v.getChannelData(e);for(let n=0;n<_;n+=1){let r=n/_,i=Math.sin(n*(e===0?.071:.083))*.13;t[n]=(Math.random()*2-1+i)*(1-r)**2.75*.62}}m.buffer=v,h.gain.value=.34,m.connect(h),h.connect(c);let y=g.getChannelData(0),b=0;for(let e=0;e<y.length;e+=1)b=b*.82+(Math.random()*2-1)*.18,y[e]=b;let x=null,S=null,C=null,w=0,T=0,E=0,D=!1,O=!1,k=!1,ee=0,A=0,te=new Float64Array(Qc.length),j=`deep`,M=`deep`,N=0,P=0,F=(e,n,r)=>{if(r<=0)return;let i=t.createGain();i.gain.value=r,e.connect(i),i.connect(n)},I=(e,t,n,r,i=!1)=>{F(e,i?o:c,t),F(e,u,n),F(e,m,r)},ne=(e,n)=>{let r=t.createOscillator(),i=t.createGain();r.type=`sine`,r.frequency.setValueAtTime(130,e),r.frequency.exponentialRampToValueAtTime(55,e+.18),i.gain.setValueAtTime(1e-4,e),i.gain.exponentialRampToValueAtTime(.34*n,e+.008),i.gain.exponentialRampToValueAtTime(1e-4,e+.3),r.connect(i),I(i,.9,0,0,!0),r.start(e),r.stop(e+.34)},re=(e,n)=>{let r=t.createBufferSource(),i=t.createBiquadFilter(),a=t.createGain();r.buffer=g,i.type=`highpass`,i.frequency.value=5200,i.Q.value=.7,a.gain.setValueAtTime(1e-4,e),a.gain.exponentialRampToValueAtTime(.18*n,e+.004),a.gain.exponentialRampToValueAtTime(1e-4,e+.085),r.connect(i),i.connect(a),I(a,.7,.09,.12),r.start(e,T*.173%1.35),r.stop(e+.1)},ie=e=>{let n=t.createBufferSource(),r=t.createBiquadFilter(),i=t.createGain();n.buffer=g,n.loop=!0,r.type=`highpass`,r.frequency.setValueAtTime(2600,e),r.frequency.exponentialRampToValueAtTime(6200,e+1.5),r.Q.value=.65,i.gain.setValueAtTime(1e-4,e),i.gain.exponentialRampToValueAtTime(.7,e+.004),i.gain.exponentialRampToValueAtTime(1e-4,e+1.7),n.connect(r),r.connect(i),I(i,.75,.12,.45),n.start(e),n.stop(e+1.75),[3169,4523,6173].forEach(n=>{let r=t.createOscillator(),a=t.createGain();r.type=`triangle`,r.frequency.value=n,a.gain.value=.025,r.connect(a),a.connect(i),r.start(e),r.stop(e+1.75)})},L=(e,n)=>{let r=t.createBufferSource(),i=t.createBiquadFilter(),a=t.createGain();r.buffer=g,i.type=`bandpass`,i.frequency.value=7200,i.Q.value=1.15,a.gain.setValueAtTime(1e-4,e),a.gain.exponentialRampToValueAtTime(.21*n,e+.018),a.gain.exponentialRampToValueAtTime(1e-4,e+.105),r.connect(i),i.connect(a),I(a,.7,.05,.08),r.start(e,T*.219%1.3),r.stop(e+.12)},R=(e,n)=>{let r=t.createOscillator(),i=t.createOscillator(),a=t.createGain(),o=M===`glass`?n===2?82.41:65.41:M===`velvet`?n===2?69.3:58.27:n===2?65.41:73.42;r.type=`sine`,i.type=`sine`,r.frequency.value=o,i.frequency.value=o*2,i.detune.value=-4,a.gain.setValueAtTime(1e-4,e),a.gain.exponentialRampToValueAtTime(.12,e+.018),a.gain.exponentialRampToValueAtTime(1e-4,e+.52),r.connect(a),i.connect(a),I(a,.84,0,0,!0),r.start(e),i.start(e),r.stop(e+.58),i.stop(e+.58)},z=(e,n,r=1)=>{let i=t.createBiquadFilter(),a=t.createGain(),o=M===`glass`?[1046.5,1318.51,1567.98,1760]:M===`velvet`?[932.33,1108.73,1396.91,1661.22]:n===1?[880,1174.66,1318.51,1396.91]:[880,1046.5,1174.66,1318.51],s=[-7,3,-3,6];i.type=`lowpass`,i.Q.value=.8,i.frequency.setValueAtTime(1700,e),i.frequency.exponentialRampToValueAtTime(n===2?3400:4200,e+.055),i.frequency.exponentialRampToValueAtTime(1500,e+.64),a.gain.setValueAtTime(1e-4,e),a.gain.exponentialRampToValueAtTime(.075*r,e+.014),a.gain.exponentialRampToValueAtTime(1e-4,e+.72),i.connect(a),I(a,.34,.62,.46),o.forEach((n,r)=>{let a=t.createOscillator();a.type=r%2==0?`triangle`:`sine`,a.frequency.value=n,a.detune.value=s[r],a.connect(i),a.start(e),a.stop(e+.82)})},ae=e=>{let r=t.createGain(),i=M===`velvet`?[932.33,1396.91,1864.66]:M===`glass`?[1046.5,1567.98,2093]:[880,1318.51,1760],a=n*4;r.gain.setValueAtTime(1e-4,e),r.gain.exponentialRampToValueAtTime(.033,e+.19),r.gain.exponentialRampToValueAtTime(1e-4,e+a),I(r,.6,.42,.6),i.forEach((n,i)=>{let o=t.createOscillator();o.type=`sine`,o.frequency.value=n,o.detune.value=i*3-3,o.connect(r),o.start(e),o.stop(e+a+.05)})},oe=e=>{let n=t.createBufferSource(),r=t.createBiquadFilter(),i=t.createGain();n.buffer=g,r.type=`bandpass`,r.frequency.setValueAtTime(2600,e),r.frequency.exponentialRampToValueAtTime(1450,e+.22),r.Q.value=.65,i.gain.setValueAtTime(1e-4,e),i.gain.exponentialRampToValueAtTime(.65,e+.002),i.gain.exponentialRampToValueAtTime(.06,e+.01),i.gain.exponentialRampToValueAtTime(.82,e+.013),i.gain.exponentialRampToValueAtTime(.08,e+.021),i.gain.exponentialRampToValueAtTime(.95,e+.025),i.gain.exponentialRampToValueAtTime(1e-4,e+.24),n.connect(r),r.connect(i),I(i,.8,.035,.24),n.start(e,T*.173%1.2),n.stop(e+.26);let a=t.createOscillator(),o=t.createGain();a.type=`sine`,a.frequency.setValueAtTime(180,e),a.frequency.exponentialRampToValueAtTime(105,e+.065),o.gain.setValueAtTime(1e-4,e),o.gain.exponentialRampToValueAtTime(.1,e+.004),o.gain.exponentialRampToValueAtTime(1e-4,e+.09),a.connect(o),I(o,.8,0,0,!0),a.start(e),a.stop(e+.11)},se=(e,t)=>{let n=e%16;e%8==0&&M!==j&&(M=j,p.gain.setTargetAtTime(M===`glass`?.58:M===`velvet`?.46:.53,t,.15),f.frequency.setTargetAtTime(M===`glass`?5400:M===`velvet`?3e3:4200,t,.15)),n%2==0&&ne(t,(n%8==0?1:.76)*(M===`velvet`?.83:1)),(M===`glass`?[0,3,8,11,14]:M===`velvet`?[0,7,12]:[0,6,8,12]).includes(n)&&R(t,Math.floor(e/16)%4),e%32==15&&z(t,Math.floor(e/32)%3,.32);let i=A;A=0;let a=k?ee:0;Qc.forEach((e,n)=>{t<te[n]&&(a|=e)});let o=(e,t)=>!!(i&e||a&e&&t);o(Zc.hats,e%2==1)&&re(t,e%4==3?1.4:1),o(Zc.shaker,!0)&&(L(t,1),L(t+r*.52,.6)),o(Zc.pad,e>=P)&&e>=P&&(ae(t),P=e+8),o(Zc.pulse,e%4==2)&&ne(t,.38),o(Zc.dub,e%4==3)&&z(t,Math.floor(e/8)%3),a&Zc.clap&&e%4==2&&oe(t)},ce=()=>{let e=t.currentTime+.1;if(w<t.currentTime+.005){let e=Math.ceil((t.currentTime+.005-w)/r);T+=e,w+=e*r}for(;w<e;)se(T,w),T+=1,w+=r},le=()=>{if(C)return;let e=t.createBufferSource(),n=t.createBiquadFilter(),r=t.createGain();e.buffer=g,e.loop=!0,n.type=`bandpass`,n.frequency.value=1700,n.Q.value=.45,r.gain.value=.012,e.connect(n),n.connect(r),I(r,.32,.12,.18),e.start(),C=e},ue=()=>{ce(),x===null&&(x=window.setInterval(ce,45))},de=()=>{x!==null&&window.clearInterval(x),x=null};return{start:async()=>{if(t.state===`closed`)return!1;if(D&&!O&&t.state===`running`)return!0;let e=++N;k=!0;try{await t.resume()}catch{return e===N&&(k=!1,A=0),!1}if(t.state!==`running`||e!==N)return!1;S!==null&&window.clearTimeout(S),S=null;let n=!D;return n&&(D=!0,E=t.currentTime+.055,w=E,T=0,le(),ie(E)),A|=ee,ue(),O=!1,i.gain.cancelScheduledValues(t.currentTime),i.gain.setValueAtTime(Math.max(i.gain.value,1e-4),t.currentTime),i.gain.exponentialRampToValueAtTime(.22,t.currentTime+(n?.045:.3)),!0},setMuted:e=>{if(t.state===`closed`)return;O=e,k=!O,O&&(N+=1);let n=t.currentTime;S!==null&&window.clearTimeout(S),S=null,i.gain.cancelScheduledValues(n),i.gain.setValueAtTime(Math.max(i.gain.value,1e-4),n),i.gain.exponentialRampToValueAtTime(O?1e-4:.22,n+(O?.22:.5)),O&&(A=0,te.fill(0),S=window.setTimeout(()=>{S=null,!(!O||t.state===`closed`)&&(de(),t.suspend())},280))},setMovement:e=>{if(e!==ee){if(k){let n=e&~ee,r=ee&~e;A|=n,Qc.forEach((e,i)=>{n&e&&(te[i]=0),r&e&&(te[i]=t.currentTime+8)})}ee=e}},setTrack:e=>{j=e},getBeat:()=>!D||t.state!==`running`?null:Math.max(0,(t.currentTime-E)/n),dispose:()=>{N+=1,k=!1,de(),S!==null&&window.clearTimeout(S),S=null;try{C?.stop()}catch{}C=null,t.close()}}}function tl({active:e}){let t=(0,l.useRef)(null);return(0,l.useEffect)(()=>{let e=t.current;if(!e)return;let n;try{n=new zc({canvas:e,alpha:!0,antialias:!0,powerPreference:`low-power`,premultipliedAlpha:!1})}catch{return}n.setClearColor(0,0),n.outputColorSpace=He,n.toneMapping=4,n.toneMappingExposure=1.12;let r=new Hn,i=new ia(34,1,.1,10);i.position.z=3.8;let a=new Ci(1,28,18),o={uTime:{value:0}},s=new ji({vertexShader:Jc,fragmentShader:Yc,uniforms:o,transparent:!0,depthWrite:!0,side:0,toneMapped:!0}),c=new ai(a,s);c.rotation.x=-.07,r.add(c);let l=0,u=performance.now(),d=0,f=window.matchMedia(`(prefers-reduced-motion: reduce)`),p=f.matches,m=()=>{o.uTime.value=d,n.render(r,i)},h=()=>{let t=e.getBoundingClientRect(),r=Math.max(1,Math.round(t.width)),a=Math.max(1,Math.round(t.height));n.setPixelRatio(Math.min(window.devicePixelRatio,1.5)),n.setSize(r,a,!1),i.aspect=r/a,i.updateProjectionMatrix(),m()},g=e=>{let t=Math.min((e-u)/1e3,.05);u=e,d+=t,c.rotation.y+=t*(Math.PI*2/36),m(),l=window.requestAnimationFrame(g)},_=()=>{if(window.cancelAnimationFrame(l),u=performance.now(),p||document.hidden){m();return}l=window.requestAnimationFrame(g)},v=e=>{p=e.matches,_()},y=new ResizeObserver(h);return y.observe(e),f.addEventListener(`change`,v),document.addEventListener(`visibilitychange`,_),h(),_(),()=>{window.cancelAnimationFrame(l),y.disconnect(),f.removeEventListener(`change`,v),document.removeEventListener(`visibilitychange`,_),r.remove(c),a.dispose(),s.dispose(),n.dispose(),n.forceContextLoss()}},[]),(0,$.jsx)(`div`,{className:`qua-orb ${e?`qua-orb--active`:``}`,role:`img`,"aria-label":`QUA art project`,children:(0,$.jsx)(`canvas`,{ref:t,className:`qua-orb__canvas`,"aria-hidden":`true`})})}function nl(){let e=(0,l.useRef)(null),t=(0,l.useRef)(null),n=(0,l.useRef)(!1),r=(0,l.useRef)(!1),i=(0,l.useRef)(`deep`),[a,o]=(0,l.useState)(!1),[s,c]=(0,l.useState)(!1),[u,d]=(0,l.useState)(!0),[f,p]=(0,l.useState)(!1),[m,h]=(0,l.useState)(`deep`),g=()=>{n.current=!0,r.current=!0;let e=t.current;e||(e=el(),t.current=e),e&&(e.setTrack(i.current),e.start().then(n=>{n&&r.current&&t.current===e&&p(!0)}))},_=()=>{let e=t.current;if(r.current){r.current=!1,e?.setMuted(!0),p(!1);return}g()},v=()=>{(!n.current||r.current)&&g()},y=e=>{i.current=e,h(e),t.current?.setTrack(e),(!n.current||r.current)&&g()};return(0,l.useEffect)(()=>{let e=window,n=!1,r=null,a=null,o=()=>{n||t.current||(t.current=el(),t.current?.setTrack(i.current))};return e.requestIdleCallback?r=e.requestIdleCallback(o,{timeout:1600}):a=window.setTimeout(o,850),()=>{n=!0,r!==null&&e.cancelIdleCallback?.(r),a!==null&&window.clearTimeout(a),t.current?.dispose(),t.current=null}},[]),(0,l.useEffect)(()=>{let n=e.current;if(!n)return;let i;try{i=new zc({canvas:n,antialias:!1,powerPreference:`high-performance`})}catch{window.setTimeout(()=>d(!1),0);return}let a=n.getBoundingClientRect(),s=Math.max(1,Math.round(a.width)),l=Math.max(1,Math.round(a.height)),u=window.matchMedia(`(pointer: coarse)`).matches,f=u?.62:s<768?.72:.88;i.setPixelRatio(Math.min(window.devicePixelRatio,f)),i.setSize(s,l,!1),i.outputColorSpace=He,i.toneMapping=4,i.toneMappingExposure=1;let m=new Hn,h=new aa(-1,1,1,-1,0,1),g=new Si(2,2),_=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,v={uResolution:{value:new Pt(s,l)},uCosmicBeat:{value:0},uMusicBeat:{value:0},uCometSeed:{value:Math.random()*997},uAltBeat:{value:0},uRealityMix:{value:0},uAltDistance:{value:Gc.distance},uBoxTurn:{value:new Pt(Gc.boxYaw,Gc.boxPitch)},uCameraPosition:{value:new q(.35,1.05,9.25)},uCameraForward:{value:new q(0,-.06,-1).normalize()},uCameraRight:{value:new q(1,0,0)},uCameraUp:{value:new q(0,1,0)},uMotion:{value:+!_}},y=new ji({vertexShader:Kc,fragmentShader:qc,uniforms:v,depthTest:!1,depthWrite:!1});m.add(new ai(g,y));let b=v.uCameraPosition.value,x=v.uCameraForward.value,S=v.uCameraRight.value,C=v.uCameraUp.value,w=v.uBoxTurn.value,T=new Set,E=.038,D=.112,O=Vc,k=1.55,ee=3.35,A=Gc.distance,te=1.1,j=Xc,M=Xc/4,N=1.04,P=10500/M,F=j/1.13,I=E,ne=D,re=O,ie=I,L=ne,R=re,z=A,ae=z,oe=Gc.boxYaw,se=Gc.boxPitch,ce=0,le=0,ue=0,de=!1,fe=null,pe=0,B=`cosmic`,me=!1,he=!1,ge=!1,_e=!1,ve=0,ye=!1,be=0,xe=0,Se=0,Ce=new Map,we=!document.hidden,Te=performance.now(),Ee=performance.now(),De=new Set([`a`,`d`,`w`,`s`,`q`,`e`,`arrowleft`,`arrowright`,`arrowup`,`arrowdown`,`r`]),V=()=>{Ee=performance.now()},Oe=0,ke=0,Ae=e=>{Oe=e,ke=performance.now()+520,H()},H=()=>{let e=ye||performance.now()<ke?Oe:0,n=T.has(`a`)||T.has(`arrowleft`),r=T.has(`d`)||T.has(`arrowright`),i=T.has(`e`)||T.has(`arrowup`),a=T.has(`q`)||T.has(`arrowdown`);n!==r&&(e|=n?Zc.hats:Zc.shaker),i!==a&&(e|=i?Zc.pad:Zc.pulse),T.has(`w`)!==T.has(`s`)&&(e|=T.has(`w`)?Zc.dub:Zc.clap),(B===`entering`||B===`returning`||!we)&&(e=0),t.current?.setMovement(e)},je=(e,t)=>{if(Math.abs(e)+Math.abs(t)<1.5)return;let n=0;Math.abs(e)>Math.abs(t)*.6&&(n|=e<0?Zc.hats:Zc.shaker),Math.abs(t)>Math.abs(e)*.6&&(n|=t<0?Zc.pad:Zc.pulse),Ae(n)},U=()=>{let e=Math.cos(ne)*re;b.set(Math.sin(I)*e,Math.sin(ne)*re,Math.cos(I)*e),x.copy(b).multiplyScalar(-1).normalize(),S.set(Math.cos(I),0,-Math.sin(I)).normalize(),C.crossVectors(S,x).normalize()},W=()=>{I=ie=Gc.azimuth,ne=L=Gc.elevation,z=ae=A,oe=Gc.boxYaw,se=Gc.boxPitch,w.set(oe,se),U()},Me=e=>{document.pointerLockElement===n&&(B===`entering`||B===`returning`||((e.movementX!==0||e.movementY!==0)&&V(),je(e.movementX,e.movementY),ie-=e.movementX*Wc,L-=e.movementY*Wc))},Ne=()=>{let e=document.pointerLockElement===n;o(e),V(),e||(T.clear(),Oe=0,ke=0,H())},Pe=e=>{if(document.pointerLockElement!==n&&!(e.pointerType===`mouse`&&e.button!==0)){if(e.cancelable&&e.preventDefault(),ye=!0,o(!0),V(),be=e.clientX,xe=e.clientY,e.pointerType===`touch`&&(Ce.set(e.pointerId,{x:e.clientX,y:e.clientY}),Ce.size===2)){Oe=0,H();let e=[...Ce.values()];Se=Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y)}try{n.setPointerCapture(e.pointerId)}catch{}}},Fe=e=>{if(!ye||document.pointerLockElement===n)return;if(e.cancelable&&e.preventDefault(),B===`entering`||B===`returning`){be=e.clientX,xe=e.clientY,Ce.has(e.pointerId)&&Ce.set(e.pointerId,{x:e.clientX,y:e.clientY}),Se=0;return}if(e.pointerType===`touch`){let t=Ce.get(e.pointerId);if(!t)return;if(Ce.set(e.pointerId,{x:e.clientX,y:e.clientY}),Ce.size>=2){let e=[...Ce.values()],t=Math.hypot(e[0].x-e[1].x,e[0].y-e[1].y);if(Se>0&&t>0){let e=Nt.clamp(t/Se,.85,1.15),n=e**1.15;Math.abs(e-1)>.001&&Ae(e>1?Zc.dub:Zc.clap),B===`alternate`?ae/=n:B===`cosmic`&&(R/=n)}Se=t,V();return}let n=e.clientX-t.x,r=e.clientY-t.y;be=e.clientX,xe=e.clientY,(n!==0||r!==0)&&V(),je(n,r),ie-=n*.004,L-=r*.004;return}let t=e.clientX-be,r=e.clientY-xe;be=e.clientX,xe=e.clientY,(t!==0||r!==0)&&V(),je(t,r),ie-=t*Uc,L-=r*Uc},Ie=e=>{if(e.pointerType===`touch`){Ce.delete(e.pointerId),Se=0;let t=Ce.values().next().value;t&&(be=t.x,xe=t.y),ye=Ce.size>0}else ye=!1;Oe=0,ke=0,H();try{n.hasPointerCapture(e.pointerId)&&n.releasePointerCapture(e.pointerId)}catch{}V()},Le=e=>{if(e.target?.matches(`button, input, textarea, select`))return;let t=e.key.toLowerCase();document.pointerLockElement===n&&t.startsWith(`arrow`)&&e.preventDefault(),T.add(t),H(),De.has(t)&&V(),t===`r`&&(B===`cosmic`||B===`alternate`)&&(B===`alternate`?W():(ie=E,L=D,R=O))},Re=e=>{let t=e.key.toLowerCase();T.delete(t),H(),De.has(t)&&V(),t===`w`&&(me=!1)},ze=()=>{T.clear(),Ce.clear(),Se=0,ye=!1,Oe=0,ke=0,H(),me=!1},Be=()=>{let e=n.getBoundingClientRect(),t=Math.max(1,Math.round(e.width)),r=Math.max(1,Math.round(e.height)),a=u?.62:t<768?.72:.88;i.setPixelRatio(Math.min(window.devicePixelRatio,a)),i.setSize(t,r,!1),v.uResolution.value.set(t,r)},Ve=()=>{we=!document.hidden,we||ze(),we&&V()};U();let Ue={passive:!1},We=new ResizeObserver(Be);We.observe(n),document.addEventListener(`mousemove`,Me),document.addEventListener(`pointerlockchange`,Ne),n.addEventListener(`pointerdown`,Pe,Ue),n.addEventListener(`pointermove`,Fe,Ue),n.addEventListener(`pointerup`,Ie,Ue),n.addEventListener(`pointercancel`,Ie,Ue),n.addEventListener(`lostpointercapture`,Ie,Ue),window.addEventListener(`keydown`,Le,{passive:!1}),window.addEventListener(`keyup`,Re),window.addEventListener(`blur`,ze),document.addEventListener(`visibilitychange`,Ve),Be();let Ge=e=>{ve=window.requestAnimationFrame(Ge);let n=Math.min((e-Te)/1e3,.04);if(Te=e,!we)return;H();let a=T.has(`a`)||T.has(`d`)||T.has(`w`)||T.has(`s`)||T.has(`q`)||T.has(`e`)||T.has(`arrowleft`)||T.has(`arrowright`)||T.has(`arrowup`)||T.has(`arrowdown`)||T.has(`r`),o=B===`cosmic`||B===`alternate`,s=o&&!_&&!ye&&!a&&e-Ee>1200,l=1-Math.exp(-2.4*n);if(ue+=(+!!s-ue)*l,s&&(ce=(ce+M/60*n*Math.PI*2*v.uMotion.value)%(Math.PI*2)),s){let e=.86+.14*(.5+.5*Math.sin(ce)),t=M/60*n*.024*N*e*ue*v.uMotion.value;ie+=t}let u=s&&B===`cosmic`;if(u&&!de){let e=Math.log(ee),t=Math.log(38),n=Nt.clamp((Math.log(R)-e)/(t-e),0,1),r=Math.acos(1-n*2);le=le<=Math.PI?r:Math.PI*2-r}if(u){le=(le+n*Math.PI/P*N*v.uMotion.value)%(Math.PI*2);let e=.5-.5*Math.cos(le);R=Math.exp(Nt.lerp(Math.log(ee),Math.log(38),e))}de=u;let d=s?j:F,f=t.current?.getBeat()??null;v.uMusicBeat.value=_?0:f??v.uMusicBeat.value+Xc/60*n,f!==null&&v.uMotion.value>0?(fe===null&&(fe=v.uCosmicBeat.value-f),v.uCosmicBeat.value=f+fe):(fe=null,v.uCosmicBeat.value+=d/60*n*v.uMotion.value),v.uAltBeat.value+=Xc/120*n*v.uMotion.value;let g=T.has(`shift`)?2.15:1;o&&((T.has(`a`)||T.has(`arrowleft`))&&(ie-=n*.74*g),(T.has(`d`)||T.has(`arrowright`))&&(ie+=n*.74*g),(T.has(`q`)||T.has(`arrowdown`))&&(L-=n*.62*g),(T.has(`e`)||T.has(`arrowup`))&&(L+=n*.62*g));let y=T.has(`w`)&&!T.has(`s`)&&!me,b=T.has(`s`)&&!T.has(`w`);B===`cosmic`?(y&&(R*=Math.exp(-n*.5*g)),b&&(R*=Math.exp(n*.5*g))):B===`alternate`&&(y&&(ae*=Math.exp(-n*.52*g)),b&&(ae*=Math.exp(n*.52*g))),R=Nt.clamp(R,k,38),ae=Nt.clamp(ae,te,180),ie=Math.atan2(Math.sin(ie),Math.cos(ie)),L=Math.atan2(Math.sin(L),Math.cos(L));let x=1-Math.exp(-6.4*n),S=1-Math.exp(-5*n),C=I,be=ne,xe=z,Se=Math.atan2(Math.sin(ie-I),Math.cos(ie-I)),Ce=Math.atan2(Math.sin(L-ne),Math.cos(L-ne));if(I+=Se*x,ne+=Ce*x,I=Math.atan2(Math.sin(I),Math.cos(I)),ne=Math.atan2(Math.sin(ne),Math.cos(ne)),re+=(R-re)*S,z+=(ae-z)*S,B===`alternate`){let e=Math.atan2(Math.sin(I-C),Math.cos(I-C)),t=Math.atan2(Math.sin(ne-be),Math.cos(ne-be)),r=xe-z,i=v.uMotion.value;oe+=e*.96+r*.11+n*.16*i,se+=t*.84+r*.045+n*.09*i,oe%=Math.PI*40,se%=Math.PI*40,w.set(oe,se)}U(),B===`cosmic`&&R<=k+.001&&re<=k+.025&&(B=`entering`,he=!1,me=!0,c(!0),V()),B===`alternate`&&ae<=te+.001&&z<=te+.018&&(B=`returning`,me=!0,ge=!1,_e=!1,V()),B===`entering`?(pe=Math.min(1,pe+n/.86),!he&&pe>=.5&&(W(),he=!0),pe>=1&&(B=`alternate`,V())):B===`returning`&&(pe=_e?.5:Math.max(0,pe-n/.86),!ge&&pe<=.5&&(ge=!0,_e=!0,r.current=!1,t.current?.setMuted(!0),p(!1),window.location.assign(Hc)),pe<=0&&(B=`cosmic`,I=ie=E,ne=L=D,re=R=O,z=ae=A,oe=Gc.boxYaw,se=Gc.boxPitch,w.set(oe,se),ue=0,le=0,de=!1,c(!1),U(),V())),v.uRealityMix.value=pe,v.uAltDistance.value=z,i.render(m,h)};return ve=window.requestAnimationFrame(Ge),()=>{window.cancelAnimationFrame(ve),document.removeEventListener(`mousemove`,Me),document.removeEventListener(`pointerlockchange`,Ne),n.removeEventListener(`pointerdown`,Pe,Ue),n.removeEventListener(`pointermove`,Fe,Ue),n.removeEventListener(`pointerup`,Ie,Ue),n.removeEventListener(`pointercancel`,Ie,Ue),n.removeEventListener(`lostpointercapture`,Ie,Ue),window.removeEventListener(`keydown`,Le),window.removeEventListener(`keyup`,Re),window.removeEventListener(`blur`,ze),document.removeEventListener(`visibilitychange`,Ve),We.disconnect(),y.dispose(),g.dispose(),i.dispose()}},[]),(0,$.jsxs)(`main`,{className:`experience-shell`,children:[(0,$.jsx)(`canvas`,{ref:e,className:`space-canvas`,tabIndex:0,"aria-label":s?`Interactive chrome portal realm floating above an ocean with a solid-black sphere`:`Interactive three-dimensional view of a black hole and accretion disk`,"aria-describedby":`controls`,onPointerDown:v,onClick:()=>{let t=e.current;if(t){if(t.focus({preventScroll:!0}),!window.matchMedia(`(hover: hover) and (pointer: fine)`).matches||typeof t.requestPointerLock!=`function`){o(!0);return}try{t.requestPointerLock()?.catch(()=>o(!1))}catch{o(!1)}}}}),!u&&(0,$.jsx)(`div`,{className:`fallback`,role:`alert`,children:`This browser cannot render the live space.`}),(0,$.jsxs)(`div`,{className:`hud-stack`,children:[(0,$.jsx)(tl,{active:a}),(0,$.jsxs)(`aside`,{id:`controls`,className:`controls ${a?`controls--active`:``}`,"aria-label":`Experience controls`,children:[(0,$.jsxs)(`div`,{className:`controls-heading`,children:[(0,$.jsx)(`span`,{className:`status-dot`}),(0,$.jsxs)(`span`,{className:`controls-heading__label`,children:[(0,$.jsx)(`span`,{className:`controls-heading__desktop`,children:s?`PORTAL REALM ACTIVE`:a?`ORBIT ACTIVE`:`CLICK SPACE TO ENTER`}),(0,$.jsx)(`span`,{className:`controls-heading__touch`,children:s?`PORTAL REALM ACTIVE`:a?`TOUCH ORBIT ACTIVE`:`TOUCH SPACE TO ENTER`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`sound-toggle ${f?`sound-toggle--on`:``}`,"aria-label":f?`Mute ambient dub techno`:`Play ambient dub techno`,"aria-pressed":f,title:f?`Mute ambient dub`:`Play ambient dub`,onPointerDown:e=>e.stopPropagation(),onClick:e=>{e.stopPropagation(),_()},children:[(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{})]})]}),s?(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`dl`,{className:`desktop-controls`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Orbit`}),(0,$.jsxs)(`dd`,{children:[`Mouse `,(0,$.jsx)(`span`,{children:`/`}),` `,(0,$.jsx)(`kbd`,{children:`↑↓←→`})]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Enter sphere`}),(0,$.jsx)(`dd`,{children:(0,$.jsx)(`kbd`,{children:`W`})})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Retreat to ocean`}),(0,$.jsx)(`dd`,{children:(0,$.jsx)(`kbd`,{children:`S`})})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Recenter`}),(0,$.jsx)(`dd`,{children:(0,$.jsx)(`kbd`,{children:`R`})})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Release`}),(0,$.jsx)(`dd`,{children:(0,$.jsx)(`kbd`,{children:`ESC`})})]})]}),(0,$.jsxs)(`dl`,{className:`touch-controls`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Orbit`}),(0,$.jsx)(`dd`,{children:`One-finger drag`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Enter sphere`}),(0,$.jsx)(`dd`,{children:`Pinch outward`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Retreat to ocean`}),(0,$.jsx)(`dd`,{children:`Pinch inward`})]})]})]}):(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`dl`,{className:`desktop-controls`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Orbit`}),(0,$.jsxs)(`dd`,{children:[`Mouse `,(0,$.jsx)(`span`,{children:`/`}),` `,(0,$.jsx)(`kbd`,{children:`↑↓←→`})]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Approach / retreat`}),(0,$.jsxs)(`dd`,{children:[(0,$.jsx)(`kbd`,{children:`W`}),(0,$.jsx)(`span`,{children:`/`}),(0,$.jsx)(`kbd`,{children:`S`})]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Below / above`}),(0,$.jsxs)(`dd`,{children:[(0,$.jsx)(`kbd`,{children:`Q`}),(0,$.jsx)(`span`,{children:`/`}),(0,$.jsx)(`kbd`,{children:`E`})]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Recenter`}),(0,$.jsx)(`dd`,{children:(0,$.jsx)(`kbd`,{children:`R`})})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Release`}),(0,$.jsx)(`dd`,{children:(0,$.jsx)(`kbd`,{children:`ESC`})})]})]}),(0,$.jsxs)(`dl`,{className:`touch-controls`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Orbit`}),(0,$.jsx)(`dd`,{children:`One-finger drag`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Approach`}),(0,$.jsx)(`dd`,{children:`Pinch outward`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`Retreat`}),(0,$.jsx)(`dd`,{children:`Pinch inward`})]})]})]}),(0,$.jsxs)(`div`,{className:`track-picker`,role:`group`,"aria-label":`Choose a ${Xc} BPM base track`,children:[(0,$.jsxs)(`div`,{className:`track-picker__label`,children:[`BASE TRACK `,(0,$.jsxs)(`span`,{children:[Xc,` BPM`]})]}),(0,$.jsx)(`div`,{className:`track-picker__options`,children:$c.map(e=>(0,$.jsx)(`button`,{type:`button`,"aria-pressed":m===e.id,title:`${e.description}. Changes on the next bar.`,onPointerDown:e=>e.stopPropagation(),onClick:t=>{t.stopPropagation(),y(e.id)},children:e.label},e.id))})]}),(0,$.jsxs)(`p`,{className:`music-guide`,children:[`Left · hats / Right · shaker`,(0,$.jsx)(`br`,{}),`Up · pad / Down · pulse`,(0,$.jsx)(`br`,{}),`Approach · dub / Retreat · clap on 2 & 4`]}),(0,$.jsx)(`p`,{className:`music-guide music-guide--quiet`,children:`Hold to loop. Release · rides for 8 seconds.`})]})]}),(0,$.jsx)(`p`,{className:`sr-only`,"aria-live":`polite`,children:s?`Portal realm active. Move forward through the solid-black sphere to continue into the original QUA experience.`:a?`Immersive controls active. Press Escape to release the cursor.`:`Immersive controls inactive.`})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(nl,{}));